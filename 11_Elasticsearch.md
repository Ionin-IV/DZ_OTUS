...
Результат: найдены все документы, содержащие чёткое совпадение с одним из слов запроса.
...
Результат: найден ещё один документ, не содержащий слов из запрошенной фразы. Очевидно, что слово "рама" было интерпретировано, как слово "мама" с ошибкой.
