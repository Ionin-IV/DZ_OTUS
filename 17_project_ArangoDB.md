...
3. Большой объём графовых данных в ArangoDB загружается очень быстро за доли секунд. В Neo4j большие данные загружаются с уменьшением скорости по мере увеличения уже загруженных данных. Есть предположение, что чем больше данных в БД уже есть, тем дольше ищутся и выстраиваются загружаемые данные. Индексы немного улучшают ситуация, но всё равно очень долго.
