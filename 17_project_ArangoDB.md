...
1. Графовые данные для загрузки в ArangoDB нужно предварительно готовить, т.к. загрузка каждого узла и связи производится из отдельного набора данных. При загрузке в Neo4j данные из json можно раскладывать прямо из каждой записи, что гораздо удобней.
