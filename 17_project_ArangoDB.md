...
2. Графовые данные в ArangoDB хранятся в виде таблиц с документами, что удобно, т.к. можно обратиться к ним напрямую. Так же можно построить и граф по уже имющимся в БД таблицам с документами. Это тоже большой плюс.
