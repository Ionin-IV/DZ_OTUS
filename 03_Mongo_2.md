...
8. Количество документов на 1-м шарде не изменилось, т.к. они не смогли загрузиться, а на 2-3 шардах есть добавленные документы:
```
[direct: mongos] test> db.operations.getShardDistribution()
Shard shard03 at shard03/lab10:27017,lab11:27017,lab12:27017
{
...
**ВЫВОД: если нужна жёсткая привязка роли primary к узлу, имея при этом резервный сервер на время недоступности основного, то это можно сделать с помощью приоритетов.**
